...
my $absicondir = "/opt/fhem/www/pgm5/icons";   		# Copy your icons here
my $relicondir = "/icons";
my $gnuplotdir = "/opt/fhem/FHEM"; 				# the .gplot filees live here (should be the FHEM dir, as FHEMRENDERER needs them there)
my $fhemwebdir = "/opt/fhem";			# the fhemweb.pl & style.css files live here
...
my $configfile = "/opt/fhem/fhem.conf";					# the fhem.conf file is that
